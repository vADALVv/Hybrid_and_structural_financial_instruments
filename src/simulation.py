...
class SimulateBasketPrices:
    ...
    def simulate_prices(self, base_price, vol, corr, base_strike=None, weights=None, rate=0., method="levy"):
      '''
      Parameters
      ----------
      ... (остальные параметры без изменений)
      method : str, optional
          Метод для расчета цены (levy или ju_taylor)
      '''
      ...
      for i in range(self.n_prices):
          ...
          elif method == "ju_taylor":
              basket_prices.append(basket.ju_taylor_approximation_call())
          else:
